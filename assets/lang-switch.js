...
(function() {
  ...
  const translations = {
    pl: {
      ...
      contactName: 'Dane kontaktowe',
      contactEmail: 'Email',
      contactPhone: 'Telefon',
      contactAddress: 'Adres',
      contactNip: 'NIP',
      contactHoursTitle: 'Profesjonalne wsparcie',
      contactHours: 'Poniedziałek - Piątek: 8:00 - 18:00',
      contactSupport: 'Dedykowane wsparcie dla naszych klientów w godzinach pracy',
    ...
    en: {
      ...
      contactName: 'Contact Information',
      contactEmail: 'Email',
      contactPhone: 'Phone',
      contactAddress: 'Address',
      contactNip: 'Tax ID',
      contactHoursTitle: 'Professional Support',
      contactHours: 'Monday - Friday: 8:00 AM - 6:00 PM',
      contactSupport: 'Dedicated support for our clients during business hours',
